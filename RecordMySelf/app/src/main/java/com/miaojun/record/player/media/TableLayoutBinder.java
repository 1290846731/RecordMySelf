...
package com.miaojun.record.player.media;
...
public class TableLayoutBinder {
    ...
    public View appendRow1(String name, String value) {
        return appendRow(R.layout.ijk_table_media_info_row1, name, value);
    }
    ...
    public View appendRow2(String name, String value) {
        return appendRow(R.layout.ijk_table_media_info_row2, name, value);
    }
    ...
    public View appendSection(String name) {
        return appendRow(R.layout.ijk_table_media_info_section, name, null);
    }
